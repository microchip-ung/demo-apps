...
extern vtss_rc demo_init(vtss_init_data_t *data);
extern const char *demo_error_txt(vtss_rc error);
...
extern vtss_rc demo_tx_frame(vtss_port_no_t port_no, vtss_mac_t dmac, int method, int swtch);

extern void demo_npi(BOOL enable, BOOL use_npi, vtss_port_no_t port_no);
extern void demo_evc_main(void);
extern void demo_acl_main(void);

extern void demo_evc_main_ece_clear(vtss_port_no_t port_no);
extern void demo_evc_main_ece_statistics(vtss_port_no_t port_no);

extern void demo_qce_create(void);
extern void demo_qce_config_key(void);

extern vtss_rc demo_shaper(u32 r);
...
extern int demo_socket_client(vtss_ip_t ip_addr);
extern int demo_socket_server(vtss_ip_t ip_addr);
