...
#define DEMO_PLATFORM_CRIT_ENTER()  critd_enter(&demo_platform_crit)
#define DEMO_PLATFORM_CRIT_EXIT()   critd_exit(&demo_platform_crit)
#define DEMO_PLATFORM_CRIT_ASSERT_LOCKED()  critd_assert_locked(&demo_platform_crit)
...
#define DEMO_FLAG_MASTER_DOWN     (1<<2)
#define DEMO_FLAG_MASTER_UP       (1<<3)
#define DEMO_FLAG_SWITCH_ADD      (1<<4)
#define DEMO_FLAG_SWITCH_DEL      (1<<5)
#define DEMO_FLAG_SUSPEND_RESUME  (1<<6)
#define DEMO_FLAG_WARMSTART_QUERY (1<<7)

#define DEMO_FLAG_PACKET_RX       (1<<8)

#define DEMO_FLAG_SHOW_DEMO       (1<<9)
#define DEMO_FLAG_OAM_TX         (1<<10)
