...
static vtss_rc update_src_mac(mesa_port_no_t port_no, void* p, mesa_mac_t dmac)
{
    vtss_isid_t     isid;
...
static vtss_rc demo_os_tx_method_1(mesa_port_no_t port_no, mesa_mac_t dmac)
{
    vtss_rc rc;
    void *p;
 ...
 */
static vtss_rc demo_packet_tx_method_2(mesa_port_no_t port_no, mesa_mac_t dmac, int swtch)
{
    vtss_rc rc;
    u8 *p;
    vtss_common_framelen_t length=64;
...
vtss_rc demo_tx_frame(mesa_port_no_t port_no, mesa_mac_t dmac, int method, int swtch)
{
    vtss_rc rc;
