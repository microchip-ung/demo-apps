...
static vtss_rc update_src_mac(vtss_port_no_t port_no, void* p, vtss_mac_t dmac)
{
    vtss_isid_t     isid;
...
static vtss_rc demo_os_tx_method_1(vtss_port_no_t port_no, vtss_mac_t dmac)
{
    vtss_rc rc;
    void *p;
 ...
 */
static vtss_rc demo_packet_tx_method_2(vtss_port_no_t port_no, vtss_mac_t dmac, int swtch)
{
    vtss_rc rc;
    void *p;
    vtss_common_framelen_t length=64;
    ...
    tx_props.packet_info.frm[0] = (u8 *)p;
    tx_props.packet_info.len[0] = length;
...
vtss_rc demo_tx_frame(vtss_port_no_t port_no, vtss_mac_t dmac, int method, int swtch)
{
    vtss_rc rc;
