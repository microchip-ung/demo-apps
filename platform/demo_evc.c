...
vtss_rc create_ece()
{
  ...
  // (2) --- Create an ECE / UNI
    ...
    //
    ece_conf.key.type = VTSS_ECE_TYPE_LLC;//VTSS_ECE_TYPE_IPV4; // 5tupple_ip4
    ...
    // It does not matter if  action.rule is VTSS_ECE_RULE_RX or VTSS_ECE_RULE_BOTH. But is
...
vtss_rc create_ece2()
{
  ...
  // (2) --- Create an ECE / UNI
    ...
    ece_conf.key.lookup = 0;
    ece_conf.action.dir = VTSS_ECE_DIR_NNI_TO_UNI;//VTSS_ECE_DIR_BOTH;
    ...
    ece_conf.action.inner_tag.type = VTSS_ECE_INNER_TAG_C;
