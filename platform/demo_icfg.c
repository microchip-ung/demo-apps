...
static mesa_rc demo_icfg_query_func_vlanconfig(const vtss_icfg_query_request_t *req,
...
static mesa_rc demo_icfg_query_func_config(const vtss_icfg_query_request_t *req,
					   vtss_icfg_query_result_t *result)
{
  mesa_rc rc;
...
static mesa_rc demo_icfg_query_func_per_interface(const vtss_icfg_query_request_t *req,
						  vtss_icfg_query_result_t *result)
{
