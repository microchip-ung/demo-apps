...
mesa_rc demo_init(vtss_init_data_t *data)
{
    ...
    case INIT_CMD_MASTER_UP:
        vtss_flag_setbits(&demo_thread_flag, DEMO_FLAG_MASTER_UP);
        break;

    case INIT_CMD_MASTER_DOWN:
        vtss_flag_setbits(&demo_thread_flag, DEMO_FLAG_MASTER_DOWN);
        break;

    case INIT_CMD_SWITCH_ADD:
        vtss_flag_setbits(&demo_thread_flag, DEMO_FLAG_SWITCH_ADD);
        break;

    case INIT_CMD_SWITCH_DEL:
        vtss_flag_setbits(&demo_thread_flag, DEMO_FLAG_SWITCH_DEL);
        break;
